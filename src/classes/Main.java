...
public class Main {
	...
	private static AddressBookInterface myBook = new AddressBook();
	...
	private static void changeMyBookDetails() {
		...
		System.out.println(a.getVorname() + ", " + a.getNachname() + ", "
				+ a.getTelefonnummer() + ", " + a.getMail());

		ContactDetails details = new ContactDetails("Roberto", "Dziubao",
				"123456789", "12345@web.de", "Sonntagstr. 27");
	...
	private static void getMyBookDetails() {
		...
		System.out.println(c.getVorname() + ", " + c.getNachname() + ", "
				+ c.getTelefonnummer() + ", " + c.getMail());
